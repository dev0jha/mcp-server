...
const handler = createMcpHandler(
  (server) => {
    ...
    server.tool(
      "creatorInfo",
      "Get detailed information about Dev - Full Stack Developer and Open Source Contributor",
      {},
      async () => ({
        content: [
          {
  ...
  },
  {
    capabilities: {
      tools: {
        creatorInfo: {
          description:
            "Get detailed information about Dev - Full Stack Developer and Open Source Contributor (Creator of this tool).",
        },
        getDocument: {
          description:
            "Get a document by its unique ID from the Appwrite database",
